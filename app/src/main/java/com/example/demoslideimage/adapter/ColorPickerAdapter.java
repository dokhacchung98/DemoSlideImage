...
import com.example.demoslideimage.databinding.ColorPickerItemListBinding;
...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ColorPickerItemListBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext())
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(ColorPickerItemListBinding binding) {
